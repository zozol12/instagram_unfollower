...
def main():
    ...
    unfollower = InstagramUnfollower(username, password, 3)  # just increase the number to unfollow slower,
    # and decrease to unfollow faster. ( Making too fast may possible shows you as a bot to Instagram )
